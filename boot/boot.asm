...
; TODO: as was discovered there is a problem in LBA_CHS function
READ_SECTORS:
    .MAIN:
        mov di, 0x0005
    .READLOOP:
...
LOAD_ROOT_DIR:
    ...
    div WORD [bpb_bytes_per_sector] ; total number of sectors used by root dir
    ...
    add ax, WORD [bpb_reserved_sectors] ; don't forget about reserved sectors

    ; datasector points to the data region containing the files and directories
...
LOAD_FAT:
    ...
    mov ax, WORD [bpb_reserved_sectors] ; FATs begin right after the boot sector
